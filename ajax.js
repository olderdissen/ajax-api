...
//	settings.xhr.onload = function {}
//	settings.xhr.onloadend = function {}
//	settings.xhr.onloadstart = function {}

	settings.xhr.onprogress = function()
		{
		if(settings.progress)
			settings.progress(settings.xhr, settings.xhr.status, settings.xhr.statusText);
		}
